...
export default function App() {
  ...
  useEffect(()=>{ document.title=route.id==='home'?'Inference Atlas · A field guide for engineers':`${page?.title || (route.id==='bookmarks'?'Saved resources':'The library')} · Inference Atlas`; setMenu(false); if(!route.section)window.scrollTo({top:0,behavior:'instant'}); },[route.id]);
